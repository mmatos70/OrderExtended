		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Orders Extented",
									"targetURL": "#marceloorderextended-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"marceloorderextended-display": {
								"semanticObject": "marceloorderextended",
								"action": "display",
								"description": "Orders Extented - Hierarchy",
								"title": "Orders Extented",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=marcelo.orderextended",
									"url": sap.ui.require.toUrl("marcelo/orderextended")
								}
							}
						}
					}
